...
class Company extends CI_Controller {
	...
	{
		$data['bia'] = $this->get();
		$this->load->template('pages/setting/company/index',$data);
	}

	public function view($id)
	{
		$this->load->template('pages/setting/company/view',$id);
	}

	public function edit($id)
	{
		$this->load->template('pages/setting/company/edit',$id);
	}
	...
	public function create()
	{
		...
		$this->load->template('pages/setting/company/create',$data);
	}
