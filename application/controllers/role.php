...
class Role extends MY_Controller {
	...
	{
		$data['bia'] = $this->get();
		$this->load->template('pages/role/index',$data);
	}

	public function view($id)
	{
		$this->load->template('pages/role/view',$id);
	}

	public function edit($id)
	{
		$this->load->template('pages/role/edit',$id);
	}

	 public function create()
	{
		$this->load->template('pages/role/create');
	}
