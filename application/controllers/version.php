...
class Version extends MY_Controller {
	...
	{
		$data['bia'] = $this->get();
		$this->load->template('pages/setting/version/index',$data);
	}

	public function view($id)
	{
		$this->load->template('pages/setting/version/view',$id);
	}

	public function edit($id)
	{
		$this->load->template('pages/setting/version/edit',$id);
	}
	...
	public function create()
	{
		...
		$this->load->template('pages/setting/version/create',$data);
	}
