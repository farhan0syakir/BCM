									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="form-group">
													<label class="label-bold">Kode Unit Business Activity</label>
												...
												<div class="form-group">
													...
													<table class="table-gap">
														<tr class="tr-gap">
															...
															<td>
																<div class="gap col-md-12  " id = "finansialImpact">
																...
																<?php for ($i = 1; $i <= $impactSelectLength; $i++ )  : ?>
																	...
																	<select class="form-control" id = "finansialImpactSelect<?php echo $i?>"> 
														...
														<tr class="tr-gap">
															...
															<td>
																<div class="gap col-md-12  " id  = "nonFinansialImpact">
																<?php for ($i = 1; $i <= count($impactLabel); $i++ )  : ?>
																	<div class="gap col-md-2 " >
																	<label class="gap-narrow"> <?php echo $impactLabel[$i-1]?>  </label>
																	<select class="form-control" id = "nonFinansialImpactSelect<?php echo $i?>"> 
																		<option value="">Please select</option>
																		<?php for ($j = 0; $j < count($baImpact); $j++ )  : ?>
																			<option onClick = "
																				<?php
																...
																<form role="form">
																	...
																	<div class="row  bottom-gap-narrow">
																		<div class="col-lg-12 text-right">
																			<button class="button-gap" onClick="addInput('alternativeMethodsId', 'alternativeMethodsId',5,true)">Add
												...
												<tr class="tr-gap">
													<td>
														<form role="form">
															<div class="form-group text-center">
																<label class="label-bold ">
																	<h4 class="title-header ">Normal</h4>
																</label>
															</div>
															<div class="form-group">
															...
															<div class="form-group">
																...
																<input type="number" class="num  form-control" placeholder="">
															</div>
															<div class="form-group">
									...
									<div class="panel-body">
										<div class="row">
																...
																<form role="form">
																	...
																	<table>
																		<tr class="gap col-md-12">
																				...
																				<td class="gap col-md-6">
																					<label class="gap-narrow" >RPO</label>
														...
														<form role="form">
																	...
																	<table>
																		...
																		<tr class="gap col-md-12 ">
																				...
																				<td class="gap col-md-6">
																				<input type="checkbox" value=""> CPU</td>
																		...
																		<tr class="gap col-md-12 ">
																				...
																				<td class="gap col-md-6">
																				<input type="checkbox" value=""> Monitor</td>
											...
											<div class="top-gap row">
												...
												<div class="col-lg-6 text-right" >
													<a class="edit-button-gap" data-toggle="tab" href="#nonit">Next
													<span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
													</a>
												</div>
											</div>
																...
																<form role="form">
																	<table>
																		<tr class="gap col-md-12">
																				...
																				<td class="gap col-md-6">
																					<label class="gap-narrow">Equipment</label>
																				</td>
																		...
																		<tr class="gap col-md-12 ">
																				...
																				<td class="gap col-md-6">
																				<input type="checkbox" value=""> ATK</td>
																...
																<form role="form">
																	<table>
																		...
																		<tr class="gap col-md-12 ">
																				...
																				<td class="gap col-md-6">
																				<input type="checkbox" value=""> Trade blotter from SUMMIT
																				</td>
																		...
																		<tr class="gap col-md-12 ">
																				...
																				<td class="gap col-md-6"><input type="checkbox" value=""> Treasury Policy & Procedure
																				</td>
