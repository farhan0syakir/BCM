													...
													<div class="col-md-12  " id = "finansialImpactDivId">
														...
														<div class="gap col-md-2 " >
															<label class="gap-narrow"> 
																<?php echo $impact_parameter[$i]." ".unserialize(type_label_bu)[$impact_parameter_type[$i]]?>
															</label>
											...
											<tr class="tr-gap">
												<td>
													...
													<div class="form-group">
														...
														<input name="cubicles" type="number" min="0" class="input-short form-control" placeholder="">
													</div>
													<div class="form-group">
														<label class="label-bold">PC/Notebook</label>
														<input name="notebooks" type="number" min="0" class="input-short form-control" placeholder="">
													</div>
												...
												<td>
													<table>
														<tr class="gap col-md-12">
															...
															<td class="td-gap col-md-2"><label class="gap-narrow" >location</label></td>
